...
public class MemberVO {
	...
	public int getMemberRentCount() {
		return memberRentCount;
	}
	public void setMemberRentCount(int memberRentCount) {
		this.memberRentCount = memberRentCount;
	}
